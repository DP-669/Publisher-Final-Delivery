        ...
        if st.button("Generate Descriptions"):
             with st.spinner("Council Auditing Descriptions..."):
                 ...
                 for track in st.session_state.app_data['tracks']:
                     ...
                     new_desc = st.session_state.engine.call_gemini('gemini-1.5-pro', sys_instr, prompt, api_key)
    ...
    with col1:
        ...
        if st.button("Synthesize Album Description"):
            with st.spinner("Synthesizing..."):
                ...
                res = st.session_state.engine.call_gemini('gemini-1.5-pro', sys_instr, prompt, api_key)
